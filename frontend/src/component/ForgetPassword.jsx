...
const ForgetPassword = () => {
    ...
    const checkMailExists = async () => {
        const res = await fetch(`http://localhost:3000/users1/getbyemail/${emailRef.current.value}`);
    ...
    const updatePassword = async (values) => {
        const res = await fetch(`http://localhost:3000/users1/update/${verifiedUser._id}`, {
            method: 'PUT',
